...
//益智故事
public class PuzzleStoryFragment extends Fragment {
    ...
    public static Fragment newInstance() {
        PuzzleStoryFragment fragment = new PuzzleStoryFragment();
        return fragment;
    }
    ...
    public void parseMusic() {
        ...
        try {   //解析怀旧娱乐网的HTML字符串
            Document document = Jsoup.connect("http://www.gushi365.com/yizhigushi/index_" + wenNumber+".html").get();
