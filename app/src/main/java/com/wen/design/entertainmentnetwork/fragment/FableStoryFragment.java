...
//寓言故事
public class FableStoryFragment extends Fragment {
    ...
    public static Fragment newInstance() {
        FableStoryFragment fragment = new FableStoryFragment();
        return fragment;
    }
            ...
            protected void onLoading(int countItem, int lastItem) {
                handler = new Handler() {
                    ...
                    public void handleMessage(Message msg) {
                        ...
                        //如果在第一项添加模拟数据需要调用 scrollToPos ition（0）把列表移动到顶端（可选）
    ...
    public void parseMusic() {
        ...
        try {   //解析怀旧娱乐网的HTML字符串
            Document document = Jsoup.connect("http://www.gushi365.com/yuyangushi/index_" + wenNumber+".html").get();
