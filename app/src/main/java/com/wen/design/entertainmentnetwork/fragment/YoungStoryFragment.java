...
//儿童故事
public class YoungStoryFragment extends Fragment {
    ...
    public static Fragment newInstance() {
        YoungStoryFragment fragment = new YoungStoryFragment();
        return fragment;
    }
    ...
    public void parseMusic() {
        ...
        try {   //解析怀旧娱乐网的HTML字符串
            Document document = Jsoup.connect("http://www.gushi365.com/xiaogushi/index_" + wenNumber+".html").get();
