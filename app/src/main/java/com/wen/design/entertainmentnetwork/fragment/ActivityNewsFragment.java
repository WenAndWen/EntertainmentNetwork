...
public class ActivityNewsFragment extends Fragment {
    ...
    public static Fragment newInstance() {
        ActivityNewsFragment fragment = new ActivityNewsFragment();
        return fragment;
    }
    ...
    public void parseMusic() {
        ...
        try {   //解析怀旧娱乐网的HTML字符串
            Document document = Jsoup.connect("http://www.gushi365.com/ertonggushi/index_" + wenNumber+".html").get();
            ...
            for (i = 0; i < element.size(); i++) {
                ...
                bundle.putString("urlText", element.get(i).select("h2.entry-title").attr("href"));
